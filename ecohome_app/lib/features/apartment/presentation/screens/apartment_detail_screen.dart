...
import 'package:ecohome_app/features/apartment/data/apartment_model.dart';
import 'package:ecohome_app/features/apartment/data/apartment_service.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class ApartmentDetailScreen extends StatelessWidget {
  ApartmentDetailScreen({super.key});
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // --- 2. NỘI DUNG CHÍNH ---
            Expanded(
              child: StreamBuilder<ApartmentModel>(
                stream: apartmentService.getApartment(),
